...
async def poll(ctx, *, question: str = None):
    try:
        if question is None:
            raise commands.BadArgument()
        embed = discord.Embed(
            title="📊 Poll", description=question, color=discord.Color.gold()
        )
...
async def weather(ctx, *, city: str):
    ...
    try:
        ...
        if data["cod"] != "404":
            ...
            embed.add_field(
                name="Trạng thái", value=description.capitalize(), inline=False
            )
            embed.set_thumbnail(
                url=f"http://openweathermap.org/img/wn/{weather_data['icon']}@2x.png"
            )
...
COMMAND_LIST = [
    {
        ...
        "commands": [
            ...
            (
                ...
                "Gửi tin nhắn đến channel chỉ định.",
            ),
            (
                "!embedcreate",
                None,
                "!embedcreate #channel [Author] [Title] [Desc] [Img] [Thumb] [Footer] [FooterIcon] [Color]",
                "Tạo và gửi embed vào channel.",
            ),
        ],
    },
    {
    ...
    },
    {
        ...
        "commands": [
            ...
            (
                ...
                "/timeout",
                "!timeout @user <time>",
                "Timeout người dùng (5s, 5min, 5h, 5d, 5m, 5y).",
            ),
            ...
            (
                "!slowmode",
                None,
                "!slowmode <time> hoặc off",
                "Bật/tắt slowmode cho channel.",
            ),
